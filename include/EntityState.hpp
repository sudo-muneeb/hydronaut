#pragma once
// ─── EntityState.hpp ──────────────────────────────────────────────────────────
// State Pattern for HydronautEntity.
//
...
class HydronautEntity;   // forward declaration
...
public:
    ...
    virtual void handleInput(HydronautEntity& entity,
                             int              action,
    ...
    virtual void update(HydronautEntity& entity, float dt) noexcept = 0;
...
public:
    void handleInput(HydronautEntity& entity,
                     int              action,
                     bool             dashRequested) noexcept override;

    void update(HydronautEntity& entity, float dt) noexcept override;
