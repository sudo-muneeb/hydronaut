...
//
// HydronautEntity (formerly Player) delegates ALL update-loop behaviour to
...
class HydronautEntity {
public:
    explicit HydronautEntity(sf::Vector2u windowSize);
    ~HydronautEntity() = default;
