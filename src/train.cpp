...
static constexpr int   MAX_STEPS     = 8000;  
static constexpr int   LEARN_EVERY   = 4;
static constexpr int   WARMUP_EXP    = 64;
static constexpr int   HOLD_MIN      = 4;    // lower frames for fast reactions
static constexpr int   HOLD_MAX      = 8;
...
int main(int argc, char* argv[]) {
    ...
    if (argc >= 2) {
        ...
        catch (...) { std::cerr << "inv ep count using " << EPISODES << "\n"; }
    }
