...
// ─── NormalState ─────────────────────────────────────────────────────────────
void NormalState::handleInput(HydronautEntity& entity,
                              int              action,
...
void NormalState::update(HydronautEntity& entity, float dt) noexcept {
    // Water drag
    sf::Vector2f vel = entity.getVelocity();
    vel.x *= PLAYER_DRAG;
    vel.y *= PLAYER_DRAG;
...
// ─── DashState ────────────────────────────────────────────────────────────────
void DashState::handleInput(HydronautEntity& entity,
                             int              action,
                             bool             /*dashRequested*/) noexcept {
...
void DashState::update(HydronautEntity& entity, float dt) noexcept {
